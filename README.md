# Section 1 — System Design Documentation

Index of architecture and design documents for the adaptive LMS platform.

## Contents

1. [High-Level System Architecture](#1-high-level-system-architecture)
  a. [High-Level Diagram](#a-high-level-diagram)
  b. [Request Paths for Hot Flows](#b-request-paths-for-hot-flows)
  c. [Adaptive Selection Flow](#c-adaptive-selection-flow)
  d. [Summary](#d-summary)
2. [Data Model](#2-data-model)
  a. [Entity Relationship Diagram](#a-entity-relationship-diagram)
  b. [Indexing Strategy on Hot Paths](#b-indexing-strategy-on-hot-paths)
  c. [Database Selection](#c-database-selection)
  d. [Proctoring Entities](#d-proctoring-entities)
3. [Adaptive Algorithm Design](#3-adaptive-algorithm-design)
  a. [Approach Selection](#a-approach-selection)
  b. [Core Concepts](#b-core-concepts)
  c. [Test Termination](#c-test-termination)
  d. [Edge Cases](#d-edge-cases)
  e. [Known Failure Modes](#e-known-failure-modes)
  f. [Advantages of the Rasch Model](#f-advantages-of-the-rasch-model)
4. [API Design](#4-api-design)
  a. [API Style](#a-api-style)
  b. [Submit Answer → Get Next Question](#b-submit-answer-get-next-question)
  c. [Authentication and Authorization Model](#c-authentication-and-authorization-model)
  d. [Proctoring API Endpoints](#d-proctoring-api-endpoints)
  e. [Access Control Summary](#e-access-control-summary)
5. [Concurrency, Integrity & Security](#5-concurrency-integrity-security)
  a. [Preventing Corruption from Concurrent Requests](#a-preventing-corruption-from-concurrent-requests)
  b. [Preventing Previously Submitted Answer Changes via Replay](#b-preventing-previously-submitted-answer-changes-via-replay)
  c. [Handling Browser Closure and Resume Policy](#c-handling-browser-closure-and-resume-policy)
  d. [Top 5 Security Threats and Mitigations](#d-top-5-security-threats-and-mitigations)
  e. [Webcam, Microphone Permission Abuse and Video Stream Tampering](#e-webcam-microphone-permission-abuse-and-video-stream-tampering)
6. [Scaling to 50,000 Concurrent Learners](#6-scaling-to-50000-concurrent-learners)
  a. [50,000 Learners Starting a Test in the Same 5-Minute Window](#a-50000-learners-starting-a-test-in-the-same-5-minute-window)
  b. [Bottlenecks Ranked: Top 3](#b-bottlenecks-ranked-top-3)
  c. [Scaling Plan for 10x Load](#c-scaling-plan-for-10x-load)
  d. [Preventing Question-Bank Leakage at Product and System Level](#d-preventing-question-bank-leakage-at-product-and-system-level)
  e. [Additional Bandwidth and Compute Load from Video Proctoring](#e-additional-bandwidth-and-compute-load-from-video-proctoring)
7. [Architecture Decision Records (3 ADRs)](#7-architecture-decision-records-3-adrs)
  [ADR-1: Database Choice (PostgreSQL vs MongoDB)](#adr-1-database-choice-postgresql-vs-mongodb)
  [ADR-2: Adaptive Algorithm Choice](#adr-2-adaptive-algorithm-choice)
  [ADR-3: Auth and Session Strategy](#adr-3-auth-and-session-strategy)
8. [Video Proctoring System Design](#8-video-proctoring-system-design)
  a. [Goals](#a-goals)
  b. [High-Level Architecture](#b-high-level-architecture)
  c. [Why SFU Instead of MCU](#c-why-sfu-instead-of-mcu)
  d. [WebRTC Connection Flow](#d-webrtc-connection-flow)
  e. [Recording Strategy](#e-recording-strategy)
  f. [ML Detection Pipeline](#f-ml-detection-pipeline)
  g. [Severity Scoring](#g-severity-scoring)
  h. [Reviewer Workflow](#h-reviewer-workflow)
  i. [Privacy and Compliance](#i-privacy-and-compliance)
  j. [Retention Policy](#j-retention-policy)
  k. [Failure Handling](#k-failure-handling)
  l. [Scaling Considerations](#l-scaling-considerations)
  m. [Security Considerations](#m-security-considerations)
  [Summary](#summary-2)
